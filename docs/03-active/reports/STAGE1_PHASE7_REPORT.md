...
Статус: завершена и принята владельцем 2026-09-17.
...
Phase 7 закрыта как accepted. Phase 8 требует отдельного прямого запроса и не
активирована этой приёмкой.
