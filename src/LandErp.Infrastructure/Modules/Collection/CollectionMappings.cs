...
internal static class CollectionMappings
{
    public static void Apply(ModelBuilder builder)
    {
        ...
        builder.Entity<CatalogDuplicateCandidate>().HasOne<LandErp.Application.Modules.Organization.Domain.Organization>().WithMany().HasForeignKey(item => item.OrganizationId).OnDelete(DeleteBehavior.Restrict);
        ...
        builder.Entity<CatalogPhotoFingerprint>().HasOne<LandErp.Application.Modules.Organization.Domain.Organization>().WithMany().HasForeignKey(item => item.OrganizationId).OnDelete(DeleteBehavior.Restrict);
        ...
        builder.Entity<CatalogDuplicateSettings>().HasOne<LandErp.Application.Modules.Organization.Domain.Organization>().WithMany().HasForeignKey(item => item.OrganizationId).OnDelete(DeleteBehavior.Restrict);
