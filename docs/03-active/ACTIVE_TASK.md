...
> **Активная работа:** [GATE-PROPERTY-CARD-CONCEPT.md](GATE-PROPERTY-CARD-CONCEPT.md), ветка `codex/property-card-concept`. Перенос утверждённого автономного концепта в реальную карточку и осмотр. Прямое разрешение владельца; браузерные тесты исключены.
