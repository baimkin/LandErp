...
## Текущий Gate — B1-02, первый пакет доведения до релиза
...
B1-01 уже опубликован, но его исполнение вместе с B1-02/B1-03 проверяется в B1-04. B1-03 и B1-04 не начинать без отдельного запроса. В текущем Gate не запускать build/tests/browser/Server/Worker и не менять main или БД.
