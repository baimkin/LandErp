...
**Статус:** Отложен; UI не активен в ERP-01\

> Ревизия 2026-09-14: ADR-006 сохраняется; showcase/shell scope автоматически не исполняется, UI добавляется будущим утверждённым сценарием.
