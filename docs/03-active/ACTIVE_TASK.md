...
Следующая Phase 7 master plan здесь не активируется. Локальный Parser Agent не изучался
и не менялся.
