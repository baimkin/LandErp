...
internal static class ModelConventions
{
    private static readonly Dictionary<string, string> TableComments = new(StringComparer.Ordinal)
    {
        ...
        ["negotiations"] = "Неизменяемая специализированная история переговоров PropertyCase. Публичная цена, цена продавца, предложение покупателя и согласованная цена не смешиваются.",
        ...
        ["case_attachments"] = "Связи вложений с PropertyCase, переговорами или проверками; доступ всегда наследуется от owning PropertyCase.",
    ...
    private static readonly Dictionary<string, string> ColumnComments = new(StringComparer.Ordinal)
    {
        ...
        ["PriceType"] = "Тип цены переговоров: стартовая, предложение продавца, предложение покупателя или согласованная; типы не перезаписывают друг друга.",
        ["Amount"] = "Денежное значение переговоров decimal; валюта хранится отдельно.",
        ...
        ["OwnerType"] = "Owning business object вложения: PropertyCase, переговоры или проверка.",
