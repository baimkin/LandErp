...
## Текущая работа — интеграция карточки и B1-01–B1-03
...
**Пакет B1-01–B1-03:** `54fbb73a233bbfe6a085423f0ab5fd8668b916aa`.

Scope: сохранить актуальный дизайн карточки/осмотра, встроить уникальные гарантии
B1-01–B1-03, разрешить только реальные конфликты, выполнить Release build,
целевые тесты пакета и карточки, затем запустить локальный Server на существующей
БД. Реализация B1-04/LR-03, изменение production и переписывание опубликованных
веток не входят.

Required reading: `GATE-PROPERTY-CARD-CONCEPT.md`, `RELEASE_PACKAGE_01_PLAN.md`,
`GATE-RELEASE-B1-01.md`, `GATE-RELEASE-B1-02.md`, `GATE-RELEASE-B1-03.md`, их
