...
После ручного запуска исправлено ложное завершение до прокрутки: Avito удаляет
служебные параметры `s` и `localPriority=0` после инициализации карты. Сравнение
адресов теперь не считает это сменой поисковых фильтров; проверка на фактическое
изменение города, полигона и фильтров сохранена. Регрессионный тест использует
точную форму адресов из диагностического журнала. Повторный небраузерный прогон:
101/101 успешно.
