...
internal static class ModelConventions
{
    ...
    {
        ["property_cases"] = "Рабочие кейсы закупки по объявлениям. Хранят первичный анализ, стадию, менеджера и ссылки на общие task/assignment; не полный Due Diligence.",
