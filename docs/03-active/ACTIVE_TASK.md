...
3. [Итог SPIKE-001](SPIKE-001_RESULT.md) — фактическая исходная точка и граница Collector.
4. [ADR-001](../02-decisions/ADR-001_Платформа_и_версии.md) — платформа; версии проверяются перед закреплением.
5. [ADR-002](../02-decisions/ADR-002_Структура_решения_и_границы_модулей.md) — references, один основной DbContext и владельцы данных.
6. [ADR-006](../02-decisions/ADR-006_Политика_зависимостей_и_UI-база.md) — зависимости; UI только как ограничение, не реализация.
7. [ADR-007](../02-decisions/ADR-007_Collector_как_самостоятельный_продукт_и_граница_с_Server.md) — весь документ.
8. [FP-001](../04-foundation/FP-001_Архитектурный_каркас_и_среды.md) — уточнение ERP-00, §§5–14, 16, 18: только foundation.
9. [FP-002](../04-foundation/FP-002_Идентификация_роли_права_и_аудит.md) — §§7, 13: future scope/audit invariants; Identity не реализовать.
10. [FP-004](../04-foundation/FP-004_Сквозное_ERP-ядро_и_общие_бизнес-механизмы.md) — §§1–2, 9, 14–17; правила денег/версий из §§6–7 только для review conventions.
11. [Бизнес-карта](../01-master/ERP_бизнес-карта_и_порядок_первой_реализации.md) — §§4, 7, ERP-01 в §8 и §10.
